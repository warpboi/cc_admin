...
class Admin extends Controller
{
    ...
    public function item($param = 'index')
    {
        $data['page'] = 'item';
        ...
        switch ($param) {
            case 'create':
                ...
                $this->view('admin/templates/header', $data);
                $this->view('admin/templates/sidebar', $data);
                $this->view('admin/item/create', $data);
                $this->view('admin/templates/footer');
                break;
            case 'edit':
                $data['title'] = 'Data User';
                ...
                $this->view('admin/templates/header', $data);
                $this->view('admin/templates/sidebar', $data);
                $this->view('admin/item/edit', $data);
                $this->view('admin/templates/footer');
                break;
            ...
            default:
                ...
                $this->view('admin/templates/header', $data);
                $this->view('admin/templates/sidebar', $data);
                $this->view('admin/item/index', $data);
                $this->view('admin/templates/footer');
                break;
        }
    }
    public function user($param = 'index')
    {
        $data['page'] = 'user';
